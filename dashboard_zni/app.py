...
st.image('Bootcamp.png')
st.caption('*Desarrollado por: Angie Carolina Ruiz Mercado, angiecarorumer333@gmail.com*')
...
st.markdown('<a id="evolución"></a><br><br>', unsafe_allow_html=True)
with st.container(border=True):
...
st.markdown('<a id="indicadorer-energia-activa"></a><br><br>', unsafe_allow_html=True)
with st.container(border=True):
...
###############################################################################
#           GRÁFICOS DE ENERGÍA ACTIVA POR AÑO EN MILLONES DE KWH          #
###############################################################################

st.markdown('<a id="gráficos-barras"></a><br><br>', unsafe_allow_html=True)
with st.container(border=True):
...
###############################################################################
#           GRÁFICOS DE TORATAS DE ENERGÍA ACTIVA POR AÑO EN MILLONES DE KWH          #
###############################################################################


st.markdown('<a id="gráficos-torta"></a><br><br>', unsafe_allow_html=True)
with st.container(border=True):
...
with st.sidebar.container():
    ...
    st.markdown('[Evolución de energía activa](#evolución)')
    st.markdown('[Indicadores de energía activa](#indicadorer-energia-activa)')
    st.markdown('[Gráficos Por Municipio](#gráficos-barras)')
    st.markdown('[Gráficos Por Departamento](#gráficos-torta)')